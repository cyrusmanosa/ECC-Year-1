...
class NoCoin implements GachaState{
    ...
    @Override
    public void insertCoin(GachaMachine gm){System.out.println("コインを入れました！");}
    @Override
...
class HasCoin implements GachaState{
    ...
    @Override
    public void turnHandle(GachaMachine gm){System.out.println("カプセルが出ました！");}
    @Override
    public void ejectCoin(GachaMachine gm){System.out.println("コインを返却しました！");}
}
