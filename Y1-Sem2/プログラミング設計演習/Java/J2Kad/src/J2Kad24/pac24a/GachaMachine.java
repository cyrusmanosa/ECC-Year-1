...
public class GachaMachine {
    ...
    private void turnHandle() {
        ...
        if ( count <= 0){ setState(new SoldOut());}
    }
...
class SoldOut implements GachaState {
    @Override
    public void showState(){System.out.println("売り切れ！");}
    @Override
    public void insertCoin(GachaMachine gm){System.out.println("コイン投入口が閉まっています！");}
    @Override
    public void turnHandle(GachaMachine gm){System.out.println("ハンドルが回りません！");}
    @Override
    public void ejectCoin(GachaMachine gm){System.out.println("何も起こりません！");}
